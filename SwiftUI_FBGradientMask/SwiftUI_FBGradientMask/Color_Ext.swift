...
extension ShapeStyle where Self == Color {
    // FB Gradient Mask
    public static var gradient1: Color { return Color(hex: "#C62FFF") }
    public static var gradient2: Color { return Color(hex: "#FEA7FF") }
    public static var gradient3: Color { return Color(hex: "#1AA8FF") }
    public static var gradient4: Color { return Color(hex: "#7686FF") }
}
